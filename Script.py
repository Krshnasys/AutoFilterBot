...
3) ᴍᴏᴠɪᴇ ɪs ɴᴏᴛ ᴀᴠᴀɪʟᴀʙʟᴇ ɪɴ ᴛʜᴇ ᴅᴀᴛᴀʙᴀsᴇ ʀᴇᴘᴏʀᴛ ᴛᴏ ᴀᴅᴍɪɴs</b>"""
    ...
    TOP_ALRT_MSG = """ꜱᴇᴀʀᴄʜɪɴɢ ꜰᴏʀ ǫᴜᴇʀʏ ɪɴ ɴx ᴅᴀᴛᴀʙᴀꜱᴇ..."""
...
<b>𝑷𝒍𝒆𝒂𝒔𝒆 𝒖𝒔𝒆 𝒐𝒖𝒓 𝒃𝒐𝒕 & 𝒔𝒉𝒂𝒓𝒆 𝒊𝒕 𝒘𝒊𝒕𝒉 𝒚𝒐𝒖𝒓 𝒇𝒓𝒊𝒆𝒏𝒅𝒔 𝒕𝒐 𝒔𝒖𝒑𝒑𝒐𝒓𝒕 𝒖𝒔.<b>

<b>𝒏𝒐 𝒅𝒐𝒏𝒂𝒕𝒊𝒐𝒏 𝒏𝒆𝒆𝒅𝒆𝒅!<b>

<b>Share & Support Us</b>

<b>𝑰𝒕 𝒉𝒆𝒍𝒑𝒔 𝒖𝒔 𝒌𝒆𝒆𝒑 𝒕𝒉𝒆 𝒔𝒆𝒓𝒗𝒊𝒄𝒆 𝒂𝒍𝒊𝒗𝒆, 𝒂𝒅𝒅 𝒏𝒆𝒘 𝒇𝒆𝒂𝒕𝒖𝒓𝒆𝒔<b>

<b>𝒂𝒏𝒅 𝒖𝒑𝒍𝒐𝒂𝒅 𝒎𝒐𝒓𝒆 𝒎𝒐𝒗𝒊𝒆𝒔 & 𝒘𝒆𝒃 𝒔𝒆𝒓𝒊𝒆𝒔 𝒇𝒐𝒓 𝒚𝒐𝒖<b>
...
Mᴇꜱꜱᴀɢᴇ : <b>{}</b>"""
    ...
    CAPTION = """<b><a href="https://t.me/NxMirror">{file_name}</a></b>\n\n<b>⚜️ Powered By : <a https://t.me/NxMirror>[NxMirror]</a></b>"""
...
👨‍💻 ᴄᴏɴᴛᴀᴄᴛ ᴛʜᴇ <a href='https://t.me/NxMirror'>Owner</a> ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ᴛʀɪᴀʟ.
...
‼️ 𝑨𝒇𝒕𝒆𝒓 𝑺𝒆𝒏𝒅𝒊𝒏𝒈 𝑨 𝑺𝒄𝒓𝒆𝒆𝒏𝒔𝒉𝒐𝒕 𝑷𝒍𝒆𝒂𝒔𝒆 𝑮𝒊𝒗𝒆 𝒖𝒔 𝒔𝒐𝒎𝒆 𝑻𝒊𝒎𝒆 𝑻𝒐 𝑨𝒅𝒅 𝒀𝒐𝒖 𝑰𝒏 𝑻𝒉𝒆 𝑷𝒓𝒆𝒎𝒊𝒖𝒎 𝑳𝒊𝒔𝒕.</b>"""    
 ...
 ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ◉› :<a href=https://t.me/NxMirror>NxMirror</a>\n """
...
Exᴀᴍᴘʟᴇ 👉 /Instagram ʜᴛᴛᴘs://ᴡᴡᴡ.ɪɴsᴛᴀɢʀᴀᴍ.ᴄᴏᴍ/ʀᴇᴇʟ/CTᴋ𝟷ODɢ𝟹Zɢ==<b>"""
