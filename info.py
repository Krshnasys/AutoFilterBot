...
BOT_TOKEN = environ.get('BOT_TOKEN', "7631405758:AAFqgjbwUV4JDHz51uSAkvuNg6nRc8Al3Z4")
...
PICS = (environ.get('PICS', 'https://graph.org/file/abc35f7fcdb2d0a650bc8-069e42687cc68ddd0f.jpg https://graph.org/file/5303692652d91d52180c2.jpg https://graph.org/file/425b6f46efc7c6d64105f.jpg https://graph.org/file/876867e761c6c7a29855b.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/abc35f7fcdb2d0a650bc8-069e42687cc68ddd0f.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://envs.sh/k_W.mp4")
SPELL_IMG = environ.get("SPELL_IMG", "https://graph.org/file/abc35f7fcdb2d0a650bc8-069e42687cc68ddd0f.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://graph.org/file/abc35f7fcdb2d0a650bc8-069e42687cc68ddd0f.jpg'))
FSUB_PICS = (environ.get('FSUB_PICS', 'https://graph.org/file/abc35f7fcdb2d0a650bc8-069e42687cc68ddd0f.jpg https://graph.org/file/56b5deb73f3b132e2bb73.jpg')).split()  # Fsub pic

# ============================
# Admin, Channels & Users Configuration
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6307223516').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002272615441').split()]  # Channel id for auto indexing (make sure bot is admin)
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002268947584'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002514711452'))  # Bin channel id (make sure bot is admin)
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002514711452'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002671788157'))  # Premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '-1001539207131')  # Channel/Group ID for force sub (make sure bot is admin)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002474691060').split()]
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001539207131')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001539207131')  # Request channel id (make sure bot is admin)
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1001539207131').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1001539207131').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)


# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://graph.org/file/abc35f7fcdb2d0a650bc8-069e42687cc68ddd0f.jpg')
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', '@NxMirror')

# ============================
# MongoDB Configuration
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://toeaddmix:Bc7KOwMdtaaFPCHf@cluster0.lyzmkfg.mongodb.net/?retryWrites=true&w=majority")
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://notatbeg:BplnKm7x7WwmjTjS@cluster0.hy09nwd.mongodb.net/?retryWrites=true&w=majority")
...
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/NxMirror')  # How to open tutorial link for verification
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'd73ebf51fa8ec312c94780c')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/NxMirror')  # Tutorial video link for opening shortlink website
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', False))

# ============================
# Channel & Group Links Configuration
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/NxMirror')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/NxMirror')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/NxMirror')
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/NxMirror')
OWNERID = int(os.environ.get('OWNERID', '6307223516'))  # Replace with the actual admin ID
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/NxMirror')  # Support group link (make sure bot is admin)
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002648968357')).split()]
